...
class ObjectAttentionBlock(nn.Layer):
    ...
    def __init__(self, in_channels, key_channels):
        ...
        self.f_down = layers.ConvBNReLU(in_channels, key_channels, 3)

        self.f_up = layers.ConvBNReLU(key_channels, in_channels, 3)
